...
RUN pip install flask==1.1.2 pandas==1.1.1 tensorflow==2.3.0 xlrd==1.2.0
...
RUN git clone -b adding_first_500_QA_pairs_branch --recursive https://github.com/eddiebarry/WHOA-FAQ-Answer-Project.git

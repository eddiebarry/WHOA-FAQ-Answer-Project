        ...
        stage('Prepare Environment') {
          ...
          stage("Build (Compile App)") {
            ...
            steps {
                ...
                sh '''
                python -m nltk.downloader wordnet -d /root
                python -m nltk.downloader omw -d /root
                python -m spacy download en
                python -m nltk.downloader punkt -d /root
                python -m nltk.downloader stopwords -d /root
                '''
                // echo '### Running tests ###'

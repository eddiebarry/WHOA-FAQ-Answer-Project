...
# '''
# def test_calc_search_accuracy():
#     for x in os.listdir("./accuracy_tests/intermediate_results/vsn_data_formatted"):
#         if x.endswith(".json"):
#             print(x)
...
#                 {"action":"DELETE","name":"qa_test_accuracy_test1"})

...
def test_advanced_qna():
    inp = [
        {'query': 'Could i check my calendar?', 'project_id':'1', 'version_id':'0', 'user_id': '-1', 'trigger_search': True, 'first_text':"Hi"},
        {'query': 'agenda', 'project_id':'1', 'version_id':'0', 'user_id': '768930bf736e05cc1c5609a91d9a7bff33493011c2576b7696a4ff4b676b079968d369178ea55c52c9c2f23ff87ed10ba0923c5fb63583d76aa605d826c2306b', 'first_text':"Hi"},
        {'query': 'none', 'project_id':'1', 'version_id':'0', 'user_id': '768930bf736e05cc1c5609a91d9a7bff33493011c2576b7696a4ff4b676b079968d369178ea55c52c9c2f23ff87ed10ba0923c5fb63583d76aa605d826c2306b', 'first_text':"Hi"},
    ]
    for url in urls:
        past_id = '-1'
        for x in inp:

...
*/}}
{{- define "vla.labels" -}}
helm.sh/chart: {{ include "vla.chart" . }}
{{ include "vla.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "vla.selectorLabels" -}}
app.kubernetes.io/name: {{ include "vla.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
deploymentconfig: {{ include "vla.fullname" . }}
{{- end -}}
